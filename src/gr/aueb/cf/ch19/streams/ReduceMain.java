...
public class ReduceMain {
    ...
    public static void main(String[] args) {
        ...
        int totalSum4 = numbers.parallelStream().reduce(0, Integer::sum);       // επειδή το default το combiner είναι ο accumulator, υπονοείται οτι
                                                                                // η τρίτη παράμετρος θα είναι η Integer::sum που περνάμε στον accumulator.
    }
}
